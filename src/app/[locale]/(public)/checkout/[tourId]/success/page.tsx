      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="max-w-2xl mx-auto">
          <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ type: 'spring', stiffness: 200, damping: 20 }}
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }}
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-neutral-500">{t('refCode')}</span>
                <span className="font-mono font-bold text-ice-600 text-base">{refCode}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-neutral-500">{t('guest')}</span>
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-medium text-neutral-700">{booking.count}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
              ...
              <div className="border-t border-neutral-200 pt-3 flex items-center justify-between">
                <span className="font-bold text-neutral-900">{t('totalPaid')}</span>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }}
            ...
            <p className="text-sm text-neutral-400 mb-4">{t('addNoteDesc')}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              {noteSaved && (
                <motion.span initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }}
                  className="text-sm text-emerald-600 font-medium">✓ {t('saved')}</motion.span>
              )}
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.3 }}
            ...
            <a href={`https://wa.me/?text=${encodeURIComponent(`Bora Abi Tours 🎉\nRef: ${refCode}\nTour: ${tourId}\nDate: ${booking.date}`)}`}
